...
class OrdersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'table_number' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'employee_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'table_number' => ['type' => 'index', 'columns' => ['table_number'], 'length' => []],
            'employee_id' => ['type' => 'index', 'columns' => ['employee_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'orders_ibfk_1' => ['type' => 'foreign', 'columns' => ['table_number'], 'references' => ['dining_tables', 'table_number'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
    ...
    public $records = [
        [
            'id' => 1,
            'created_at' => '2017-03-30 16:09:45',
            'updated_at' => '2017-03-30 16:09:45',
            'table_number' => 1,
            'employee_id' => 1
        ],
    ];
